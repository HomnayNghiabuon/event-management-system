...
| Thiết kế database | Đang làm | 50% |
| Viết tài liệu API | Đang làm | 50% |
| Thiết kế kiến trúc hệ thống | Đang làm | 50% |
...
|------------|-------------------|
| Nguyễn Ích Nghĩa | Hoàn thiện tài liệu API |
| Nguyễn Xuân Khánh | Hoàn thiện thiết kế database |
| Lê Hữu Lộc | Hoàn thiện sơ đồ use case & phân tích yêu cầu |
